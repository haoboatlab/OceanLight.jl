...
function convertwave!(η::Array{<:Float64,2},ηx::Array{<:Float64,2},ηy::Array{<:Float64,2},
                      η0::Array{<:Float64,2},ηx0::Array{<:Float64,2},ηy0::Array{<:Float64,2},kbc=0::Int64)    
...
function interface(ix::Int64,iy::Int64,η::Array{<:Float64,2},ηx::Array{<:Float64,2},
    ...
    # xpb, ypb is position of photon at the beginning
    # xpe, ype is position of photon at the end
    # fres - fractional reflectance for unpolarized light
    x=p.x
    y=p.y
    nx=p.nx
    ny=p.ny
    ...
    zpb=η0
    # apply refraction rule at air-water interface
...
"""
function energy!(ed1d::Array{<:Float64,1},edi::Array{<:Int64,1},edj::Array{<:Int64,1},
                 edk::Array{<:Int64,1},count::Array{<:Int64,1},kk::Int64,fres::Float64,θ::Float64,xpb::Float64,
                 ypb::Float64,zpb::Float64,xpe::Float64,ype::Float64,zpe::Float64,p::Param)
...
function surface(idie::Int64,isca::Int64,xpe::Float64,ype::Float64,zpe::Float64,
    ...
    # check if photon go through surface back to air side
